...
# Install Bookfix in editable mode (includes dependencies)
echo "📦 Installing Bookfix and dependencies..."
pip install -e .

# Download spaCy language models (explicit, not relying on post-install hook)
echo "📥 Downloading spaCy language models..."
python -m spacy download en_core_web_md
python -m spacy download en_core_web_sm
python -m spacy download en_core_web_trf

# Download NLTK data (used at runtime)
